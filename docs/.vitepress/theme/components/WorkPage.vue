...
<template>
  <div
    class="flex flex-col lg:flex-row min-h-[80vh] border border-gray-400 rounded-2xl overflow-hidden shadow-lg"
  >
    <!-- Sidebar -->
    <aside
      class="w-full lg:w-1/4 bg-gray-100 border-r border-gray-400 p-4 space-y-4 overflow-auto"
    >
    ...
    <section class="w-full bg-white lg:w-3/4 p-6 overflow-auto">
      ...
      <div v-else class="text-gray-500">Work not found.</div>
    </section>
  </div>
</template>
